    ...
    if chain_id in model:
        for residue in model[chain_id]:
            if is_aa(residue, standard=True):
                residue_numbers.append((residue.id[1], Polypeptide.three_to_one(residue.resname)))
    else:
...
# Example usage
pdb_dir = "C:\\Users\\msc2\\Desktop\\Project_data\\mhc1\\xx"
tm_align_output_dir = "C:\\Users\\msc2\\Desktop\\Project_data\\mhc1\\TM_output"
output_dir = "C:\\Users\\msc2\\Desktop\\Project_data\\mhc1\\residue_mapping"
